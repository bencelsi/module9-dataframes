...
husky.games.2015 <- read.csv(file="data/huskies_2015.csv", stringsAsFactors = FALSE)
...
MostYardsScore <- function(game.data){
  data = game.data$uw_score[max(game.data$combined) == game.data$combined]
  print(data)
}
